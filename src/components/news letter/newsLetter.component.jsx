      ...
      <div class="p-8 md:p-12 lg:px-16 lg:py-24">
        <div class="mx-auto max-w-lg text-center">
          <h2 class="text-2xl font-bold text-gray-900 dark:text-white md:text-3xl">
            Get the Headlines Delivered: Sign Up for News Wave!
          </h2>

          <p class="hidden text-gray-500 dark:text-gray-400 sm:mt-4 sm:block">
            Subscribe to News Wave and immerse yourself in a sea of knowledge.
            Dive into curated stories, breaking news, and insightful analyses –
            delivered to your inbox. Stay informed, stay inspired!
          </p>
        </div>
